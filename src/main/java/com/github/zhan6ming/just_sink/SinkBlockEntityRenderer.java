...
/**
 * 水槽液面渲染器（Forge 1.18.2）。
 * <p>
 * 与 1.20.1 的关键差异：
 * <ul>
 *     <li>使用 {@link Vector3f#YP} 替代 {@code com.mojang.math.Axis.YP}</li>
 *     <li>{@code mulPose()} 接受 {@code com.mojang.math.Quaternion}</li>
 * </ul>
 */
public class SinkBlockEntityRenderer implements BlockEntityRenderer<SinkBlockEntity> {
    ...
    public void render(SinkBlockEntity blockEntity, float partialTick, PoseStack poseStack,
        ...
        // Forge 1.18.2 使用 Vector3f.YP.rotationDegrees()
